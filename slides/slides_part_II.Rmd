...
plot(bioChemists$art,ylab='number of articles',xlab = 'Index', main="Articles distribution for single students")
...
```{r,out.width='70%',echo=FALSE}
plot(bioChemists$art,ylab='number of articles',xlab = 'Index',main="Articles distribution for Married students")

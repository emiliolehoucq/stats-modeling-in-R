...
\pause{Log-linear model model the group mean count of each cell of the contingency table} 
...
\begin{tabular}{ |c|c|c| } 
 \hline
  & mentor article : 0 & mentor article : 1 \\\hline
 student article : 0 & $\exp(5.64)$ & $\exp(5.64-0.15)$ \\\hline
 mentor article : 1 & $\exp(5.64-0.26-0.15)$ & $\exp(5.63-0.27-0.15)$ \\\hline
 \hline
\end{tabular}
\end{center}
